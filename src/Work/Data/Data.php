...
class Data
{
    use ODataValidator;
    use ODataFilter;
    public const PUBLICATION_DATE_MIN_YEAR=1900;
    public const PUBLICATION_DATE_MAX_YEAR=2100;
    public const SHORT_DESCRIPTION_AUTHORIZE_MAX_LENGTH=5000;
    public const CITATION_MAX_LENGTH=1000;
    public const TITLE_MAX_LENGTH=1000;
    public const SUBTITLE_MAX_LENGTH=1000;
    public const TRANSLATED_MAX_LENGTH=1000;
    /**
     ...
     */
    public const LANGUAGE_CODES = ['en', 'ab', 'aa', 'af', 'ak', 'sq', 'am', 'ar', 'an', 'hy', 'as', 'av', 'ae', 'ay', 'az', 'bm', 'ba', 'eu', 'be', 'bn', 'bh', 'bi', 'bs', 'br', 'bg', 'my', 'ca', 'ch', 'ce', 'zh_CN', 'zh_TW', 'cu',
     ...
     *
     */
    public const SPECIAL_LANGUAGE_CODES = ['zh_cn' => 'zh_CN', 'ZH_CN' => 'zh_CN', 'zh_tw' => 'zh_TW', 'ZH_TW' => 'zh_TW'];
     ...
     */
    public const EXTERNAL_ID_TYPE = ['agr', 'ark', 'arxiv', 'asin', 'asin-tld', 'authenticusid', 'bibcode', 'cba', 'cienciaiul', 'cit', 'ctx', 'dnb', 'doi', 'eid', 'ethos',
